...
// Creates a document fragment for iniitial book previews
...
for (const { author, id, image, title } of matches.slice(0, BOOKS_PER_PAGE)) {
    ...
    // Populates the preview element with image, title and author information
    element.innerHTML = `
        <img
    ...
    // Appends preview elements to the document fragment
